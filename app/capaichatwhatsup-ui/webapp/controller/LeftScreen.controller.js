sap.ui.define([
    ...
    return Controller.extend("capaichatwhatsupui.controller.LeftScreen", {
        ...
        onUploadFileBtnSelect: function(oEvent){
            ...
            this.fileUploadFragment ??= this.loadFragment({
                name: "capaichatwhatsupui.view.FileUploading"
            });
        ...
        onManageFileBtnSelect: function(){
            ...
            this.fileManagementFragment ??= this.loadFragment({
                name: "capaichatwhatsupui.view.FileManagement"
            });
